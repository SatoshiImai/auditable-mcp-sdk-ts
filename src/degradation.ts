 ...
 * @param options.negotiated The transport to the host, used only when the session is audit-negotiated.
 ...
 * @param options.posture What to do when the session is not audit-negotiated. Degraded by default.
 * @returns `negotiated` for an audit-negotiated session, otherwise `fallback`.
 * @throws {UnnegotiatedSessionError} The session is not audit-negotiated and the posture is mandatory.
